...
import type { AnalyticsReportRecord, PlatformOverviewRecord } from '../../domain/ports/outbound/AnalyticsRepositoryPort.js';
...
export class GetPlatformOverviewUseCase {
  ...
  async reports(): Promise<AnalyticsReportRecord> {
    return this.analyticsRepo.getReports();
  }
}
