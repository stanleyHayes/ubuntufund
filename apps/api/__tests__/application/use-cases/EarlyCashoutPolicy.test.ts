...
describe('early cashout surcharge',()=>{
 ...
 it('does not let urgent pricing undercut the configured early surcharge',()=>{expect(computePayoutFee('urgent',2000,cfg as never, 'GHS')).toEqual({fee:60,netAmount:1940})});
