...
function fixture(isAnonymous = false, donorId = GUEST_DONOR_ID) {
  ...
  const campaignRepo = {findById:vi.fn(async () => ({id:'campaign',status:'active',title:'Campaign',raisedAmount:new Money(200,'GHS'),goalAmount:new Money(1000,'GHS'),canReceiveDonation:()=>true}))};
