...
export default function ManagePlansPage() {
  ...
  const ordered = useMemo(
    () => [...plans].sort((a, b) => ORDER.indexOf(a.tier) - ORDER.indexOf(b.tier)),
    [plans],
  )
  ...
  return (
    <Box sx={{ bgcolor: 'background.default' }}>
      ...
      <Alert severity="info" sx={{ mb: 3 }}>
        Prices and limits are stored in the database and read across the platform. The code-defined defaults seed
        this list and act as a safe fallback. Use -1 for an unlimited numeric limit.
      </Alert>
