...
it('asks an unverified member to verify and sends the link on request', async () => {
  ...
  expect(await screen.findByText(/Verify your email address\. Payouts and withdrawals to a bank or mobile-money account, and organization invitations/)).toBeInTheDocument()
