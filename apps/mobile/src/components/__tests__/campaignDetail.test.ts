...
vi.mock('expo-router', () => ({ useFocusEffect: vi.fn(), useLocalSearchParams: () => ({ id: 'c1' }), Stack: { Screen: () => null }, router: { push: vi.fn() } }))
...
vi.mock('@/components/SplitDisclosure', () => ({ SplitDisclosure: () => null }))
