...
- [x] App configuration declares UserDefaults access for preferences and no tracking, removes broad/background permissions, and supplies camera/microphone/location purpose strings. This does not verify every linked SDK's manifest or production data handling.
