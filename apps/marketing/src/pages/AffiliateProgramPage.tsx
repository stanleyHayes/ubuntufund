          ...
          <Grid container spacing={3}>
            {STATS.map((stat, i) => (
              <Grid size={{ xs: 6, sm: 3 }} key={stat.label}>
                <Box sx={{ textAlign: 'center', animation: `${countIn} 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) ${i * 0.1}s both` }}>
                  <Box
                    sx={{
                      width: 56,
                      height: 56,
                  ...
                  <Typography sx={{ fontWeight: 900, fontSize: { xs: '1.6rem', md: '2rem' }, color: '#DCC07E', lineHeight: 1, mb: 0.5 }}>
                    {stat.value}
                  </Typography>
